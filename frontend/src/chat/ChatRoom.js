...
function ChatRoom() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if(roomname != ''){
                firebase.database().ref('rooms/').orderByChild('roomname').equalTo(roomname).on('value', snapshot => {
                    if (!snapshot.exists()) {
                        ...
                        <div>
                            ...
                            {users.map((item, idx) => (
                                ...
                                <Card key={idx} className="UsersCard">
                                    <CardBody>
                                        <CardSubtitle>Chat with {item.nickname}</CardSubtitle>
                                    </CardBody>
                                </Card> : <a></a>
                            ))}
                        </div>
